...
public class Shakespeare {
    static final String currentPath = "./target/classes/nl/robnoort/streams/files/";
    ...
    public static void main(String[] args) throws IOException {
        ...
        Set<String> shakespeareWords = Files.lines(Paths.get(currentPath + "words.shakespeare.txt"))
                .map(word -> word.toLowerCase()).collect(Collectors.toSet());

        Set<String> scrabbleWords = Files.lines(Paths.get(currentPath + "ospd.txt")).map(word -> word.toLowerCase())
        ...
        String bestScrabbleWord = scrabbleWords.stream().max(Comparator.comparing(score)).get();

        System.out.println("Best scrablle word: " + bestScrabbleWord + " for " + intScore.applyAsInt(bestScrabbleWord) + " points");
        ...
        System.out.println("Best word: " + bestWord + " for " + intScore.applyAsInt(bestWord) +" points" );
